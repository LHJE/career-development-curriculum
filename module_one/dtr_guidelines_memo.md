...
We’re going to be doing our collaboration primarily during Zoom.  Luke knows that he can’t focus if there’s music, so if Travis needs to do some heads-down stuff and needs some music, he’ll just go on mute.
...
We both don’t have a lot of distractions that need addressing at random times, so we’re both committed to just getting the work done, and then getting to the other things in our lives after the work is done.  That said, we’re going to be checking in with one another to make sure we’re both still doing well.

#### * If we encounter issues such as power outages, Zoom difficulties, or bad wifi, what backup plans can we have in place? (This could have answers like  asking a neighbor to borrow wifi, using cellphone hotspot for internet, switching to slack or skype.   

In this modern world, there are backup plans aplenty.  Luke and Travis can both rely on their neighbors or support system, but if it all comes crashing down, then we can just facetime on our cellphones or chat via slack or text.  

#### * Pomodoro breaks are especially important for remote work and doubly so for quarantine. What should our Pom cadence look like? How will hold ourselves accountable?  

We’re not planning on putting our phones on timers or taking 5 at the top of every hour, but if we start noticing that we’re getting snippy at certain points in the night, we will address that by mandating breaks according to the clock.

#### * Quarantine is tough, so it’s important to make note of our mental/emotional state when working with others. How can we make space to check in on each other’s well being, in addition to the work that needs to be done?  

We’ve already clicked pretty well, and have no worries that the one will check in on the other at the top of the call, or if anything comes up in the middle.
...
Our overall goal is of course to complete the project.  However, minor goals along the way are to meet our deadlines of completing an Iteration every other day, and learning how to work with people at different skill levels.
...
We can use these strengths cohesively to push each other to follow the rules a little more if we’re getting bogged down by errors, or to move past the rules if we’re short on time.

#### Schedule Expectations (When are we available to work together and individually? What constraints do we have? Make sure to discuss the remote questions above in regards to this section):  

We’re planning on meeting every evening, after dinner, and if need be in the morning before class.

#### Communication Expectations (How and often will we communicate? How do we keep lines of communication open? How will we make decisions as a team? How will we communicate about our emotional and mental well-being with each other?):  

The doors are open.  We both agree that free and open communication is not only needed, but highly welcomed.

#### Abilities & Growth Expectations (Technical strengths and areas for desired improvement):  

Travis expects to grow his understanding of working on a project remotely with a teammate, and Luke is looking to grow his understanding of the mysteries of Ruby.

#### Workload Expectations (What features do we each want to work on?):  

We both plan on doing the work together, and after doing our Iteration outline, seeing if there is work that can be divided.

#### Workflow Expectations (Git workflow/Tools/Code Review/Reviewing Pull Requests/Debugging and Problem-solving Techniques):   

We both expect that we’re able to do all of these tasks, with Luke reporting that he will need a little more help with merging Pull Requests.

#### Pomodoro Break Schedule:  

We are planning on going with the flow at first and seeing how we need to take breaks, but have a back up plan of taking a break at the top of every hour.

#### Expectations for giving and receiving feedback:  

Compliment Sandwich!  Good stuff, needs work, good stuff!
...
Zoom, GitHub, Atom Teletype, texting, Slack.
